...
def args_parser():
    ...
    parser.add_argument('--content_size', default=512, help='Content image size', type=int)
    parser.add_argument('--style_size', default=512, help='Style image size', type=int)
